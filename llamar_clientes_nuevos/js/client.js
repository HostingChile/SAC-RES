$(function(){
    ...
    $("#tbl-clients").on("change", ".contacted", function(){
     ...
     //Change create deal
        $("#tbl-clients").on("click", ".btn-create-deal", function(){
        var $modal = $("#modalconfirm");
        $modal.find('.question').removeClass("hidden");
        $modal.modal('show');
        var $client = $(this).parents(".client");
        var id = $client.data('id');
        var hosting = $client.data('empresa');
    ...
    $("#modal-btn-yes").on("click", function(){
        ...
        var params = { id: $modal.data('id'), hosting: $modal.data('empresa')};
        ...
        $.post( "request_handler.php", { action: "create_deal", params: params}, function( response ) {
